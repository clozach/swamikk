...
import { resolveImageSrc } from "../../components/image-source";
...
/** Builder alias is not a second native text leaf for the rendered legacy caption. */
export const MORE_LINK: MoreLink = { label: buttonCaption, href: buttonAction };
...
export const thumbnailSrc = (thumbnail: Post["thumbnail"]): string =>
    resolveImageSrc(normalizePostThumbnail(thumbnail).source) || "";
