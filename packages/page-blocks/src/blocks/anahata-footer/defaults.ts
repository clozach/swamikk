...
/** Current builder controls share the classic renderer's palette. */
export const GROUND = OCEAN;
export const STRIP = NAVY;
export const TEXT = WHITE;
export const HAIRLINE = OCEAN_HAIRLINE;
export const LINK_HOVER = WHITE;
