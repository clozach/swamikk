...
function EventMedia({
    ...
    return (
        <div
            className={`${ROOT}__media`}
            data-kk-image-path={`events.${index}.image`}
        >
            {isWaiting(source) ? (
                ...
                <ResponsiveImage
                    ...
                    sizes={
                        layout === "row"
                            ? "(min-width: 1100px) 445px, (min-width: 768px) 45vw, 100vw"
                            : "(min-width: 960px) 25vw, (min-width: 768px) 50vw, 100vw"
                    }
                />
            )}
        </div>
...
function EventCard({
    ...
    return (
        <article className={classes}>
            <EventMedia event={event} index={index} layout={layout} />
