...
/** Optional newer editor fields stay available without changing classic defaults. */
...
export const ledeParagraphIndex = -1;
export const secondaryCtaCaption = "";
export const secondaryCtaAction = "";
