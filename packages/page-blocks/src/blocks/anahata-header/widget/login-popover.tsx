...
const SUBMIT =
    "mt-[40px] w-full rounded-[6px] bg-[#ff9900] px-[16px] py-[10px] text-[14px] font-bold text-[#312110] transition-colors duration-100 ease-in hover:bg-[#ffbf00] disabled:cursor-not-allowed disabled:opacity-60 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--nav-fg-hover)]";
