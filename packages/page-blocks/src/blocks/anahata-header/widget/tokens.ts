...
/* Dark header surfaces use the same Clay & Saffron roles as the footer and
   wells, so dark mode cannot revive the superseded green palette. */
export const BAND_DARK = PALETTE.strip;
export const PANEL_DARK = PALETTE.wellGroundDark;
