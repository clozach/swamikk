...
import { urlSource } from "../../components/image-source";
...
/** Both current and legacy editor shapes resolve to the same classic mark. */
export const logoSource = urlSource(logoSrc);
