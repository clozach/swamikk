...
import { hasWell, isWaiting } from "../../components/image-source";
...
export default function Widget({
    ...
    const photoPresent = hasWell(photo);
            ...
            >
                ...
                <div
                    className={clsx(
                        ...
                        photoPresent ? "md:w-1/2" : "md:w-full",
                ...
                >
                    <div className="w-full max-w-[480px]">
                        {heading && (
                            <h2
                                className="font-playfair-display text-[28px] mb-5"
