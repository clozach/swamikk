...
export const PAGE_HEADER_ALL_MAILS = "Email";
export const SIDEBAR_MENU_MAILS = "Email";
export const SIDEBAR_MENU_USERS = "Users";
export const SIDEBAR_MENU_SETTINGS = "Settings";
export const SIDEBAR_MENU_PAGES = "Pages";
export const SIDEBAR_MENU_MEDIA = "Media";
export const MEDIA_MANAGER_EMPTY = "No media uploaded yet.";
export const MEDIA_MANAGER_UNUSED = "Not used anywhere";
export const MEDIA_MANAGER_LOAD_MORE = "Load more";
